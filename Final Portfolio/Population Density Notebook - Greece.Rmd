...
ggplot(gr_hex) + 
  ...
  geom_sf(data = gr_boundary, fill = NA, color = "black")
```
...
pop_raster %>%
  ...
  image_annotate("Visualization by: Mugot, Laspoña, Gier, Babac \nData: Kontur Population 2023",
                 gravity = "southwest",
                 location = "+20+20",
  ...
  image_write("Plot/Annotated_plot_GR.png", format = "png", quality = 100)
```
