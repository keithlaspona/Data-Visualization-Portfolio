...
```{r}
urls <- c(
  "https://lulctimeseries.blob.core.windows.net/lulctimeseriesv003/lc2022/26W_20220101-20230101.tif",
  "https://lulctimeseries.blob.core.windows.net/lulctimeseriesv003/lc2022/27W_20220101-20230101.tif",
  "https://lulctimeseries.blob.core.windows.net/lulctimeseriesv003/lc2022/28W_20220101-20230101.tif",
  "https://lulctimeseries.blob.core.windows.net/lulctimeseriesv003/lc2022/27V_20220101-20230101.tif",
  "https://lulctimeseries.blob.core.windows.net/lulctimeseriesv003/lc2022/28V_20220101-20230101.tif",
  "https://lulctimeseries.blob.core.windows.net/lulctimeseriesv003/lc2022/26W_20220101-20230101.tif",
...
crs <- "EPSG:4326"
if (!file.exists("is_land_cover_vrt.vrt")) {
...
terra::plotRGB(land_cover_is)

img_file <- "land_cover_is_2.png"
...
land_cover_is_resampled <- terra::resample(
  x = land_cover_is,
  y = terra::rast(elev),
  method = "near"
) %>%
...
terra::plotRGB(land_cover_is_resampled)

img_file <- "land_cover_ph.png"

terra::writeRaster(
  land_cover_is_resampled,
  img_file,
  overwrite = TRUE,
  NAflag = 255
)
...
filename <- "3d_land_cover_ph-dark.png"
...
plot <- iceland_multiclass_sf %>%
  ...
  scale_fill_manual(values = rev(iceland_multiclass_sf$colors)) +
  theme_void() +
...
magick::image_write(
  p, "3d_is_land_cover_final_is.png"
)
```