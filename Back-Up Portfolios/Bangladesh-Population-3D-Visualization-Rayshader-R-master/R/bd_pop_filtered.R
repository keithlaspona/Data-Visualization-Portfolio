...
outfile <- glue::glue("Plot/final_plot_dhaka_div.png")
...
pop_raster <- image_read("Plot/final_plot_dhaka_div.png")
...
image_annotate("Visualization by: foRhAd with Rayshader(@tylermorganwall) | Data: Kontur Population (Released 2022-06-30)",
  ...
  image_write("Plot/final_plot_edited_dhaka_div.png", format = "png", quality = 100)
